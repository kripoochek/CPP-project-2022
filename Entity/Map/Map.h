...
public:
    ...
    Map(sf::Vector2f coordinates, sf::Texture& texture_, sf::Texture& verticalTexture, sf::Texture& horizontalTexture);
    Map(int rows, int columns, sf::Vector2f coordinates, sf::Texture& texture_, sf::Texture& verticalTexture, sf::Texture& horizontalTexture);
    ...
    std::vector<std::vector<std::shared_ptr<Box>>> getBoxes();

    friend struct GameStateSerializator;
};
